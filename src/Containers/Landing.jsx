    ...
    <div className="landing-page">
      ...
      <section className="hero-section text-center py-5 bg-light">
        <Container>
          ...
          <div className="mt-4">
            <Button href="signup" variant="primary" size="lg" className="me-3">
              Join Now
            </Button>
            <Button href="signin" variant="outline-secondary" size="lg">
              Log In
            </Button>
          </div>
        </Container>
      ...
      {/* Call to Action */}
      <section className="cta-section text-center py-5 bg-dark text-light">
        <Container>
